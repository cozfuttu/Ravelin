...
import { Modal, Button, useMatchBreakpoints } from "uikit";
      ...
      >
        ...
        >
          <img
            ...
            alt="h"
            loading="eager"
            hidden={combatIndex + 1 === combatState.length}
          />
          <img
            src={`/images/hunter/missionGifs/${
              missionResult === "1" ? "HunterEndDead" : "HunterEndAlive"
            }.webp`}
            alt="haa"
            loading="eager"
            hidden={combatIndex + 1 < combatState.length}
