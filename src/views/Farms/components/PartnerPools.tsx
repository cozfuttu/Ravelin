  ...
  return (
    <Background>
      ...
      <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '16px', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        <Button onClick={onPresentModalTpgx1} style={{ backgroundColor: '#d61111' }}>Deposit TPGX #1</Button>
        <Button onClick={onPresentModalTpgx2} style={{ backgroundColor: '#d61111' }}>Deposit TPGX #2</Button>
        <Button onClick={onPresentModalTpgx3} style={{ backgroundColor: '#d61111' }}>Deposit TPGX #3</Button>
        <br />
        <Button onClick={onPresentModalTpgx4} style={{ backgroundColor: '#d61111' }}>Deposit TPGX #4</Button>
        <Button onClick={onPresentModalTpgx5} style={{ backgroundColor: '#d61111' }}>Deposit TPGX #5</Button>
